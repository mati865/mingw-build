...
RUN PATH=/root/x-tools/x86_64-w64-mingw32/bin:$PATH ct-ng build && \
    ...
    cp /root/x-tools-cross-native/HOST-x86_64-w64-mingw32/x86_64-w64-mingw32/x86_64-w64-mingw32/bin/* /root/x-tools-cross-native/HOST-x86_64-w64-mingw32/x86_64-w64-mingw32/bin && \
...
RUN PATH=/root/x-tools/i686-w64-mingw32/bin:$PATH ct-ng build && \
    ...
    cp /root/x-tools-cross-native/HOST-i686-w64-mingw32/i686-w64-mingw32/i686-w64-mingw32/bin/* /root/x-tools-cross-native/HOST-i686-w64-mingw32/i686-w64-mingw32/bin/ && \
